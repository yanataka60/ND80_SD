# 中日電工 ND8080又はND80Z3(ND80Z3.5)にSD-Cardとのロード、セーブ機能
...
　　0080～0083　　D5->C4、00->0E、07->80、01->0E
...
## 追記
2024.7.5 「TK80モード用ロード、セーブジャンプテーブル修正データ」の元データの値を修正しました。

　違いがあるとご指摘をくださいましたKatsuhiko Mito様、ありがとうございます。

誤)　　0080～0083　　7F->C4、04->0E、73->80、04->0E

正)　　0080～0083　　D5->C4、00->0E、07->80、01->0E
